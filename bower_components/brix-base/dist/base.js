        ...
        Base.prototype = {
            ...
            */
            on: function(types, selector, data, fn) {
                jQuery(this.relatedElement || this.element || this).on(types, selector, data, fn)
                return this
            },
            /*
            ...
            */
            one: function(types, selector, data, fn) {
                jQuery(this.relatedElement || this.element || this).one(types, selector, data, fn)
                return this
            },
            /*
            ...
            */
            off: function(types, selector, fn) {
                jQuery(this.relatedElement || this.element || this).off(types, selector, fn)
                return this
            },
            /*
            ...
            */
            trigger: function(type, data) {
                jQuery(this.relatedElement || this.element || this).trigger(type, data)
                return this
            },
            /*
            ...
            */
            triggerHandler: function(type, data) {
                jQuery(this.relatedElement || this.element || this).triggerHandler(type, data)
                return this
            }
        }
